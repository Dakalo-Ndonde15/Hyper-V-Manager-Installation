...
<img src="https://via.placeholder.com/800x400.png" height="80%" width="80%" alt="Restart Windows"/>
<br />
<br />
Access Hyper-V Manager: <br/>
<img src="https://via.placeholder.com/800x400.png" height="80%" width="80%" alt="Open Hyper-V Manager"/>
<br />
<br />
Create a Test Virtual Machine: <br/>
<img src="https://via.placeholder.com/800x400.png" height="80%" width="80%" alt="Create Virtual Machine"/>
<br />
</p>
